...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.entry1 = customtkinter.CTkEntry(master=self.my_frame, validate="focusout", validatecommand=self.vcmd1, placeholder_text="1-1-2023 00:00:00", text_color="white")
