...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.RightClickMenu1 = tkinter.Menu(self.entry1, tearoff=False, background='#565b5e', fg='white', font=("", 15), borderwidth=0, bd=0)
        self.RightClickMenu1.add_command(label="Paste", command=lambda: self.entry1.insert(tkinter.END, self.clipboard_get()))
        self.RightClickMenu1.add_command(label="Copy", command=copy)
        self.entry1.bind("<Button-3>", lambda event: do_popup(event, frame=self.RightClickMenu1))
        ...
        self.RightClickMenu2 = tkinter.Menu(self.entry2, tearoff=False, background='#565b5e', fg='white', font=("", 15), borderwidth=0, bd=0)
        self.RightClickMenu2.add_command(label="Paste", command=lambda: self.entry2.insert(tkinter.END, self.clipboard_get()))
        self.RightClickMenu2.add_command(label="Copy", command=copy)
        self.entry2.bind("<Button-3>", lambda event: do_popup(event, frame=self.RightClickMenu2))
        self.bind("<1>", lambda event: event.widget.focus_set())
        ...
        self.RightClickMenu3 = tkinter.Menu(self.entry3, tearoff=False, background='#565b5e', fg='white', font=("", 15), borderwidth=0, bd=0)
        self.RightClickMenu3.add_command(label="Paste", command=lambda: self.entry3.insert(tkinter.END, self.clipboard_get()))
        self.RightClickMenu3.add_command(label="Copy", command=copy)
        self.entry3.bind("<Button-3>", lambda event: do_popup(event, frame=self.RightClickMenu3))
        self.bind("<1>", lambda event: event.widget.focus_set())
        ...
        self.textbox = customtkinter.CTkTextbox(master=self.mainframe, width=250, height=80)
        self.textbox.grid(row=2, column=0, columnspan=2, padx=20, pady=(0, 20), sticky="ew")
        
        self.RightClickMenu4 = tkinter.Menu(self.textbox, tearoff=False, background='#565b5e', fg='white', borderwidth=0, bd=0)
        self.RightClickMenu4.add_command(label="Copy", command=copy)
        self.textbox.bind("<Button-3>", lambda event: do_popup(event, frame=self.RightClickMenu4))
        self.bind("<1>", lambda event: event.widget.focus_set())
        ...
        def getsla(CASECREATEDATETIME, SLA, CUSTSTART, CUSTEND):
            ...
            if create > datetime.combine(create.date(), start_time) and create < datetime.combine(create.date(), end_time):
                ...
                day1_sla = datetime.combine(create, end_time) - datetime.combine(create, start_time)
